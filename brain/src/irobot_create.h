...
//
  ...
  bool wheeldropLeft() const {
    return wheeldropLeft_;
  }
  bool wheeldropRight() const {
    return wheeldropRight_;
  }
  bool bumpLeft() const {
    return bumpLeft_;
  }
  ...
  bool cliffLeft() const {
    return cliffLeft_;
  }
  bool cliffFrontLeft() const {
    return cliffFrontLeft_;
  }
  bool cliffFrontRight() const {
    return cliffFrontRight_;
  }
  bool cliffRight() const {
    return cliffRight_;
  }
  bool deviceDetect() const {
    return deviceDetect_;
  }
  bool digitalInput3() const {
    return digitalInput3_;
  }
  bool digitalInput2() const {
    return digitalInput2_;
  }
  bool digitalInput1() const {
    return digitalInput1_;
  }
  bool digitalInput0() const {
    return digitalInput0_;
  }
  short analogSignal() const {
    return analogSignal_;
  }
  bool homeBaseChargerAvailable() const {
    return homeBaseChargerAvailable_;
  }
  bool internalChargerAvailable() const {
    return internalChargerAvailable_;
  }
  bool virtualWall() const {
    return virtualWall_;
  }
  bool leftWheelOvercurrent() const {
    return leftWheelOvercurrent_;
  }
  bool rightWheelOvercurrent() const {
    return rightWheelOvercurrent_;
  }
  bool ld2Overcurrent() const {
    return ld2Overcurrent_;
  }
  bool ld1Overcurrent() const {
    return ld1Overcurrent_;
  }
  bool ld0Overcurrent() const {
    return ld0Overcurrent_;
  }
  unsigned char ir() const {
    return ir_;
  }
  bool advanceButton() const {
    return advanceButton_;
  }
  bool playButton() const {
    return playButton_;
  }
  ...
  OpenInterface::ChargingState chargingState() const {
    return chargingState_;
  }
  short batteryVoltage() const {
    return batteryVoltage_;
  }
  short batteryCurrent() const {
    return batteryCurrent_;
  }
  short batteryTemperature() const {
    return batteryTemperature_;
  }
  short batteryCharge() const {
    return batteryCharge_;
  }
  short batteryCapacity() const {
    return batteryCapacity_;
  }
  short wallSignal() const {
    return wallSignal_;
  }
  short cliffLeftSignal() const {
    return cliffLeftSignal_;
  }
  short cliffFrontLeftSignal() const {
    return cliffFrontLeftSignal_;
  }
  short cliffFrontRightSignal() const {
    return cliffFrontRightSignal_;
  }
  short cliffRightSignal() const {
    return cliffRightSignal_;
  }
  unsigned char songNumber() const {
    return songNumber_;
  }
  bool songPlaying() const {
    return songPlaying_;
  }
  unsigned char streamPackets() const {
    return streamPackets_;
  }
  short requestedVelocity() const {
    return requestedVelocity_;
  }
  short requestedRadius() const {
    return requestedRadius_;
  }
  short requestedLeftVelocity() const {
    return requestedLeftVelocity_;
  }
